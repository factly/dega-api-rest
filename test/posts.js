    ...
    it('Should get all posts', () => {
        return request(mock)
            ...
            .then((res) => {
                ...
                //expect(post).to.have.property('_id').eq('ObjectId("5ce3b35bcbcb3d64f8a2a46e")');
                //expect(post).to.have.property('featured').eq('true');
                //expect(post).to.have.property('sticky').eq('false');
                expect(post).to.have.property('client_id').eq('Factly');
                ...
                expect(post).to.have.property('last_updated_date').eq('2019-01-30T12:20:38.282Z');
                expect(post).to.have.property('slug').eq('why-are-discounted-sms-rates-not-valid-on-certain-days');
                expect(post).to.have.property('created_date').eq('2019-01-14T17:21:00.000Z');
                // tags
                ...
                // degausers
                expect(post).to.have.property('authors');
                const degaUser = post.authors;
