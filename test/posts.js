...
describe('/api/v1/posts', () => {
    ...
    it('Should get all posts by query param tags', () => {
        return request(mock)
    ...
    it('Should get all posts by one or more query param tags', () => {
        return request(mock)
    ...
    it('Should get all posts by query param category', () => {
        return request(mock)
    ...
    it('Should get all posts by one or more query param category', () => {
        return request(mock)
    ...
    it('Should get all posts by query param user', () => {
        return request(mock)
    ...
    it('Should get all posts by one or more query param user', () => {
        return request(mock)
